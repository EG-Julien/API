<?php
    ...
    $Server = new Server("root", "Com", "115200");

    $Server->getServer('ttyACM0', 115200);
    ...
    **/
    ...
    $Datas = ['all', 'degrees', 'light', 'door', 'tension', 'a_status', 'b_status', 'blue', 'red', 'green', 'white'];
